...
class MyCorpus:
    ...
    def __iter__(self):
        # We read the parquet in one go here for speed, but process document by document
...
input_file = "riksarkivet_final_neural_sample_150k.parquet"
...
# Save Dictionary
dictionary.save("riksarkivet_final_bow_sample_dictionary_20.dict")
